...
| 特性 | `@vk0/agent-cost-mcp` | Claude Code `/cost` | Datadog LLM | New Relic AI | OpenLLMetry |
|------|:---------------------:|:-------------------:|:-----------:|:------------:|:-----------:|
| 价格 | 免费 | 免费 | $100+/月 | $99+/月 | 免费(self-host)|
| 本地优先 | ✅ | ✅ | ❌ | ❌ | ⚠️ 可选 |
| 会话级明细 | ✅ | ❌(仅总计)| ✅ | ✅ | ✅ |
| 工具级拆分 | ✅ | ❌ | ⚠️ 自定义 | ⚠️ 自定义 | ✅ |
| cache-read 感知 | ✅ | ✅ | ⚠️ 部分 | ⚠️ 部分 | ❌ |
| 优化建议 | ✅ | ❌ | ❌ | ❌ | ❌ |
| 接入成本 | 1 行 `npx` | 内置 | 几天(agent + 仪表板)| 几天 | 数小时 |
| 离线可用 | ✅ | ✅ | ❌ | ❌ | ⚠️ |
| 可被 agent 调用(MCP) | ✅ | — | ❌ | ❌ | ❌ |

**适用人群:** 想要细粒度成本可见性,但不想被供应商绑定、不想要仪表板和计费关系的独立开发者和小团队。如果你需要多用户治理和 SLA 告警,去选企业级 APM。如果你只是想知道*上周二 token 都花到哪儿了*,装这个就对了。
